...
export default function LeftSide() {
  return (
    <div className="pa3 br-l b--white-20 pre flex-shrink-0 dn-m" style={{height: "90%", flexBasis: "15rem"}}>
      <div class="mt3 mb2 mh2">
        {/* <div class=""> */}
          <div class="mt3 mb3 side-title">Apps</div>
          <div class="flex flex-column nowrap">
            <a className="pa2 link flex items-center fw4 pa1 f6 br3 dim white-90" href="#top">
            ...
            <a className="pa2 link flex items-center fw4 pa1 f6 br3 dim white-90" href="#top">
              <svg className="w1 mr1" viewBox="0 0 488.932 488.932" fill="currentColor">
                <path d="M243.158 61.361v-57.6c0-3.2 4-4.9 6.7-2.9l118.4 87c2 1.5 2 4.4 0 5.9l-118.4 87c-2.7 2-6.7.2-6.7-2.9v-57.5c-87.8 1.4-158.1 76-152.1 165.4 5.1 76.8 67.7 139.1 144.5 144 81.4 5.2 150.6-53 163-129.9 2.3-14.3 14.7-24.7 29.2-24.7 17.9 0 31.8 15.9 29 33.5-17.4 109.7-118.5 192-235.7 178.9-98-11-176.7-89.4-187.8-187.4-14.7-128.2 84.9-237.4 209.9-238.8z" />
              </svg>
              Updates
              <span class="bg-blue br-100 relative f6 top-0 right-0 left-2 w1 h1 flex items-center justify-center">3</span>
            </a>
          </div>
        </div>
        <div class="mt3">
          ...
          <div class="flex flex-column nowrap">
            <a className="pa2 link flex items-center fw4 pa1 f6 br3 dim white-90" href="#top">
              <svg className="w1 mr1" viewBox="0 0 488.455 488.455" fill="currentColor">
        ...
        <div class="mt3">
          ...
          <div class="flex flex-column nowrap">
          <a className="pa2 link flex items-center fw4 pa1 f6 br3 dim white-90" href="#top">
              <svg className="w1 mr1" viewBox="0 0 511.441 511.441" fill="currentColor">
